...
\begin{frame}[fragile]
  ...
  \begin{enumerate}
    \item 三角形相交是局部的,考虑局部区域中的三角形两两求交.如图所示
          ...
          \end{figure}
    \item 不考虑一个殷集边界上的三角形相交,大部分区域可以忽略.
          \begin{figure}[htb]
            \centering
...
\begin{frame}[fragile]
  ...
  \begin{enumerate}
    ...
    \item calTest() 最坏情况时间复杂度为$O(N^2)$,但在普遍情况是$O(N^{\frac{1}{2}})$.
          ...
          \begin{table}[]
            \resizebox{.8\textwidth}{!}{%
              \begin{tabular}{|c|c|c|c|c|c|c|}
                \hline
                三角形数量/个 & 2112     & 10880    & 34560    & 114176    & 359424     & 539392     \\ \hline
