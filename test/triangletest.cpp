...
{
  Real r1[2] = {1.0, 1.0}, r2[2] = {0.0, 0.0}, r3[2] = {2.0, -2.5}, r8[2] = {1.0, 1.0}, r9[2] = {-0.5, 1.0}, r10[2] = {0.4, 0.0}, r11[2] = {2.0, 2.0}, r12[2] = {10.0, 10.0}, r13[2] = {0.0, 1.5};
...
{
  Real r1[2] = {1.0, 1.0}, r2[2] = {0.0, 0.0}, r3[2] = {2.0, 0.0}, r8[2] = {0.4, 0.2}, r9[2] = {1.0, 1.0};
...
{
  Real r1[2] = {1.0, 1.0}, r2[2] = {0.0, 0.0}, r3[2] = {2.0, 0.0}, r8[2] = {1.0, 1.0}, r9[2] = {1.0, 0.5}, r10[2] = {4.0, 0.0}, r11[2] = {2.0, 2.0}, r12[2] = {10.0, 10.0}, r13[2] = {0.0, 1.5};
  Real ans1[3] = {1.0, 0.0, 0.0}, ans2[3] = {0.5, 0.25, 0.25}, ans3[3] = {0.0, -1.0, 2.0}, co1[3], co2[3], co3[3];
...
{
  Real r1[3] = {1.0, 1.0, 1.0}, r2[3] = {0.5, 2.0, 0.0}, r3[3] = {-2.0, -2.0, -1.0}, r4[3] = {-0.1, 0.5, 0.0}, r5[3] = {0.75, 1.5, 0.5}, r6[3] = {-4.5, -6.0, -2.0};
  Real ans1[3] = {0.3, 0.4, 0.3}, ans2[3] = {0.5, 0.5, 0.0}, ans3[3] = {0.0, -1.0, 2.0}, co1[3], co2[3], co3[3];
  ...
  Point<Real, 3> rp1 = tri.barycentric(co1), rp2 = tri.barycentric(co2), rp3 = tri.barycentric(co3);
...
{
  Real r1[2] = {1.0, 1.0}, r2[2] = {0.0, 0.0}, r3[2] = {2.0, 0.0}, r4[2] = {1.0, 0.8}, r5[2] = {0.4, 0.2}, r6[2] = {1.6, 0.2}, r7[2] = {1.0, 2.0}, r8[2] = {1.0, -10.0}, r9[2] = {6.0, 0.0}, r10[2] = {1.5, 1.0}, r11[2] = {2.5, 0.0}, r12[2] = {1.5, -5.0};
  Point<Real, 2> tp1(r1), tp2(r2), tp3(r3), tp4(r4), tp5(r5), tp6(r6), tp7(r7), tp8(r8), tp9(r9), tp10(r10), tp11(r11), tp12(r12);
  Point<Real, 2> tripoints1[] = {tp1, tp2, tp3}, tripoints2[] = {tp4, tp5, tp6}, tripoints3[] = {tp7, tp8, tp9}, tripoints4[] = {tp10, tp11, tp12};
  Triangle<Real, 2> tri1(tripoints1), tri2(tripoints2), tri3(tripoints3), tri4(tripoints4);
...
{
  Real r1[2] = {1.0, 1.0}, r2[2] = {0.0, 0.0}, r3[2] = {2.0, -2.0}, r4[2] = {0.5, 0.0}, r5[2] = {0.1, 0.0}, r6[2] = {0.5, -0.4};
