...
TEST_CASE("Prepaste","[pp1]"){
    ...
    Point<Real, 3> tripoints1[] = {tp1, tp2, tp5}, tripoints2[] = {tp2, tp4, tp5}, tripoints3[] = {tp2, tp1, tp3}, tripoints4[] = {tp1, tp5, tp3}, tripoints5[] = {tp5, tp4, tp3}, tripoints6[] = {tp2, tp3, tp4};
