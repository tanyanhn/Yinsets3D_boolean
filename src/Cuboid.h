...
class Cuboid
{
 ...
 public:
    ...
    bool contain(Point<T,3> p, Real tol=TOL)
    {
        T min[3], max[3];
        for(int j=0;j<3;j++)
        {
        ...
        for(int j=0;j<3;j++)
        {
            if(p[j] < min[j]-tol || p[j] > max[j]+tol)
            return false;
        }
        return true;
    }
...
template<class T>
inline std::vector<Cuboid<T>> Cuboid<T>::divide()
    {   
        Point<T, 3> v1{(vertex[0][0]+vertex[1][0])/2.0, (vertex[0][1]+vertex[1][1])/2.0,
                                                            (vertex[0][2]+vertex[1][2])/2.0};
        Point<T, 3> v2{(vertex[1][0]+vertex[2][0])/2.0, (vertex[1][1]+vertex[2][1])/2.0, 
                                                            (vertex[1][2]+vertex[2][2])/2.0};
        Point<T, 3> v3{(vertex[2][0]+vertex[3][0])/2.0, (vertex[2][1]+vertex[3][1])/2.0, 
                                                            (vertex[2][2]+vertex[3][2])/2.0};
        Point<T, 3> v4{(vertex[3][0]+vertex[0][0])/2.0, (vertex[3][1]+vertex[0][1])/2.0, 
                                                            (vertex[3][2]+vertex[0][2])/2.0};
        Point<T, 3> v5{(v1[0]+v3[0])/2.0, (v1[1]+v3[1])/2.0, (v1[2]+v3[2])/2.0};


        Point<T, 3> v6{(vertex[4][0]+vertex[5][0])/2.0, (vertex[4][1]+vertex[5][1])/2.0,
                                                            (vertex[4][2]+vertex[5][2])/2.0};
        Point<T, 3> v7{(vertex[5][0]+vertex[6][0])/2.0, (vertex[5][1]+vertex[6][1])/2.0, 
                                                            (vertex[5][2]+vertex[6][2])/2.0};
        Point<T, 3> v8{(vertex[6][0]+vertex[7][0])/2.0, (vertex[6][1]+vertex[7][1])/2.0, 
                                                            (vertex[6][2]+vertex[7][2])/2.0};
        Point<T, 3> v9{(vertex[7][0]+vertex[4][0])/2.0, (vertex[7][1]+vertex[4][1])/2.0, 
                                                            (vertex[7][2]+vertex[4][2])/2.0};
        Point<T, 3> v10{(v6[0]+v8[0])/2.0, (v6[1]+v8[1])/2.0, (v6[2]+v8[2])/2.0};


        Point<T, 3> v11{(vertex[4][0]+vertex[0][0])/2.0, (vertex[4][1]+vertex[0][1])/2.0,
                                                            (vertex[4][2]+vertex[0][2])/2.0};
        Point<T, 3> v12{(vertex[5][0]+vertex[1][0])/2.0, (vertex[5][1]+vertex[1][1])/2.0, 
                                                            (vertex[5][2]+vertex[1][2])/2.0};
        Point<T, 3> v13{(vertex[6][0]+vertex[2][0])/2.0, (vertex[6][1]+vertex[2][1])/2.0, 
                                                            (vertex[6][2]+vertex[2][2])/2.0};
        Point<T, 3> v14{(vertex[7][0]+vertex[3][0])/2.0, (vertex[7][1]+vertex[3][1])/2.0, 
                                                            (vertex[7][2]+vertex[3][2])/2.0};

        Point<T, 3> v15{(v11[0]+v12[0])/2.0, (v11[1]+v12[1])/2.0, (v11[2]+v12[2])/2.0};
        Point<T, 3> v16{(v12[0]+v13[0])/2.0, (v12[1]+v13[1])/2.0, (v12[2]+v13[2])/2.0};
        Point<T, 3> v17{(v13[0]+v14[0])/2.0, (v13[1]+v14[1])/2.0, (v13[2]+v14[2])/2.0};
        Point<T, 3> v18{(v14[0]+v11[0])/2.0, (v14[1]+v11[1])/2.0, (v14[2]+v11[2])/2.0}; 

        Point<T, 3> v19{(v15[0]+v17[0])/2.0, (v15[1]+v17[1])/2.0, (v15[2]+v17[2])/2.0};
        ...
        std::vector<Cuboid<T>> veccub = {cub1, cub2, cub3, cub4, cub5, cub6, cub7, cub8};
        return veccub;                                         
